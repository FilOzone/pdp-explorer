...
For more information on queries used in the subgraph client, refer [here](../../subgraph-client/src/utility/queries.ts). For instructions on building and deploying your own subgraph, refer to the [Development Guide](./development.md).
