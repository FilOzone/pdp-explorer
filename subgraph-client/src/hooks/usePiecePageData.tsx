...
export function usePiecePageData(pieceId: string | undefined, options: PiecePageOptions = {}) {
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: intentionally re-runs only when `hexCid` changes
  useEffect(() => {
    setAllRoots([]);
    setBatchIndex(0);
