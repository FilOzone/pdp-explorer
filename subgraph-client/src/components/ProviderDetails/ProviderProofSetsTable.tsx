            ...
            <tbody>
              {proofSets.map((proofSet, index) => (
                ...
                >
                  ...
                  <td className="p-2">{formatDataSize(proofSet.totalDataSize)}</td>
                  <td className="p-2">{proofSet.totalRoots}</td>
                  <td className="p-2">
                    {proofSet.lastProvenEpoch ? Number(proofSet.lastProvenEpoch).toLocaleString() : "Never"}
                  </td>
                  <td className="p-2">{formatDate(proofSet.createdAt, false)}</td>
                </tr>
              ))}
            </tbody>
          </table>
